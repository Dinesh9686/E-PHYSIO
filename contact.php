							...
							<form method="post" action="contactInsert.php">
								<div class="row">
									<div class="col-sm-6">
								      ...
								      <input type="text" required="" style="border:none;" size="30" name="name" placeholder="Full Name">											
								     </div>
									</div>
									<div class="col-sm-6">
										<div class="inbox"> 
										...
										<input type="text" style="border:none;" maxlength="10" size="30" name="phone" placeholder="Phone Number">											</div>
									</div>
									<div class="col-sm-6">
										<div class="inbox">
										<!--<label for="email">Email address<span class="required">*</span></label>--> 
										&nbsp <i class="fa fa-envelope highlight2" aria-hidden="true"></i> 
										<input type="email" required="" style="border:none;" size="30"  name="email" placeholder="Email Address">											</div>
									</div>
									<div class="col-sm-6">
									...
									<div class="col-sm-12">
										...
										&nbsp 
										<textarea  rows="3" cols="45" style="width:100%;background:url(images.png)no-repeat;border:none;" required="" name="message"  placeholder=""></textarea> </div>
									</div>
								...
								<li>
									<div class="media">
										...
										<div class="media-body">
											<h5 class="media-heading grey">Postal Address:</h5> GIT </div>
									</div>
								</li>
								<li>
									<div class="media">
										...
										<div class="media-body">
											<h5 class="media-heading grey">Phone:</h5> +91 1234567890</div>
									</div>
								</li>
								<li>
									<div class="media">
										...
										<div class="media-body">
											<h5 class="media-heading grey">Fax:</h5> +91 1234567890</div>
									</div>
								</li>
								<li>
									<div class="media">
