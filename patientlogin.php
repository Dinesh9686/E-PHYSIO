			...
			<section class="ls columns_padding_25 section_padding_top_100 section_padding_bottom_100">
				<div class="container">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div    class="inpbox"  >
											...
											<input type="email" required="" style="border:none;"  name="emailid" placeholder="Email Address">											
									    </div>
									</div>
                                    ...
                                    <div class="col-sm-12">
										...
										<input type="password" required="" size="30" style="border:none;" name="password" placeholder="Password">											
										</div>
									</div> 
					...
					<div class="col-sm-6 bottommargin_0 ">
										...
										<span class="pull-right"> <a href="patient/mail.php"> Forgot Password?</a></span>
