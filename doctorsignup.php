								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div    class="inpbox"  >
											...
											<input type="text" maxlength="10" size="30" style="border:none;" name="contact" placeholder="Contact Number">											
										</div>
									</div>
                                    <div class="col-sm-6">
										<div    class="inpbox"  >
								...
								<li>
									<div class="media">
										...
										<div class="media-body">
											<h5 class="media-heading grey">Postal Address:</h5> GP ahmedabad</div>
									</div>
								</li>
								<li>
									<div class="media">
										...
										<div class="media-body">
											<h5 class="media-heading grey">Phone:</h5> 1234567890</div>
									</div>
								</li>
								...
								<li>
									<div class="media">
										...
										<div class="media-body greylinks">
											<h5 class="media-heading grey">Email:</h5> <a href="#">lifecareinfo@gmail.com</a> </div>
									</div>
								</li>
							</ul>
						</div>
